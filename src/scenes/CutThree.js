class CutThree extends Phaser.Scene 
{
    constructor() 
    {
        ...
        this.DBOX_FONT = 'Piacevoli';	// dialog box font key
    ...
    create() 
    {
        ...
        this.dialog = this.cache.json.get('dialog3');
        ...
        // create rectangles
        this.rect01 = this.add.rectangle(centerX + textSpacer*4.8 , centerY - textSpacer*4, 72, 40, 0x000000, 0.85).setStrokeStyle(5, 0x81007f, 1)

        let nextButton = this.add.bitmapText(centerX + textSpacer*4.8 , centerY - textSpacer*4, 'Piacevoli', 'SKIP', 40).setOrigin(0.5).setTint(0x81007f);
